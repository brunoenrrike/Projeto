			...
			<div  style="margin-left: 1%; margin-right: 1%;">
				...
				<div class="formulario contorno" id="formulario" >
					<div class="form-row">
						<div class="col-md-4">
							<p class="col-md-12 ">Responsável:
								<input name="responsavel" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Tipo de Cotrato:
								<input name="tipo_contrato" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2 ">
							<p class="col-md-12 ">Nº Regsitro:<br>
								<input type="number" name="n_registro" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Nº Contrato:
								<input name="n_contrato" class="col-md-12 "value="" readonly>
							</p>
						</div>
						...
						<div class="col-md-4">
							<p class="col-md-12 ">Empresa:
								<select class="col-md-12 "  name="id_empresa" readonly>
						...
						<div class="col-md-2">
							<p class="col-md-12 ">Data Entrada:
								<input  type="date" name="data_entrada" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Data Saída:
								<input  type="date" name="data_saida" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Status:
							<select class=" col-md-12"  name="status" id="" readonly>
								<option value="">------</option>
						...
						<div class="col-md-2">
							<p class="col-md-12 ">Data Validade:
								<input  type="date" name="data_validade" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Estado:<br>			
								<select name="estados_brasil" class="col-md-12" readonly>
						...
						<div class="col-md-3">
							<p class="col-md-12 ">Cidade:
								<input name="cidade" class="col-md-12 " value=""  style="text-transform: uppercase;" readonly>
							</p>
						</div>

						<div class="col-md-3">
							<p class="col-md-12 ">Bairro:
								<input name="bairro" class="col-md-12 " value=""  style="text-transform: uppercase;" readonly>
							</p>
						</div>

						<div class="col-md-3">
							<p class="col-md-12 ">Rua:
								<input name="rua" class="col-md-12 " value=""  style="text-transform: uppercase;" readonly>
							</p>
						</div>

						<div class="col-md-1">
							<p class="col-md-12 ">Número:
								<input name="numero" class="col-md-12 "value="" readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Data do Aluguél:
								Dia: &nbsp;<input name="data_pagamento" class="col-md-5 "value="" title="Informe o dia que deve ser pago o aluguél da casa." readonly>
							</p>
						</div>

						<div class="col-md-2">
							<p class="col-md-12 ">Enviar e-mail:<br>	
								<input type="checkbox" name="enviar_email" id="enviar_email" value="1" readonly>
					...
					<p class="col-md-12 ">Observação:
						<textarea class="col-md-12 " rows="2" name="Observacao" value="" readonly></textarea>
					</p>
