	...
	<body>
		...
		<form action="bd/incluir_registro_novo.php" method="post" enctype="multipart/form-data">
			<div  style="margin-left: 1%; margin-right: 1%;">
				<p class="titulo-formulario">Editar Registro</p>
				...
				<div class="formulario contorno" id="formulario" >
					...
					<button type="submit" name="btnEditar"  id="btnEditar" class="btn btn-success col-md-2"  style="float: right;">Salvar</button>
				</div>
			</div>
		</form>
	</body>
